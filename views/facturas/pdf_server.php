...
<body>
    <div class="recibo">
        <table class="table_1" cellpadding="0" cellspacing="0" style="height: 3.4in;">
            ...
            <tr>
                ...
                <td class="borde-derecho" style="vertical-align: top; height: 2.8in;">
                    ...
                    <tr>
                        <td colspan="5" class="borde-inferior gris-claro" style="height: 25px;">
                            <span class="negrita texto-negro" style="font-size: 11pt;"><?= $factura['codigo_factura'] ?></span>
                        </td>
                    </tr>
                    
                    <!-- Fila 3: Código y Teléfono -->
                    <tr>
                        <td width="10%" class="borde-derecho borde-inferior" style="height: 22px;">Código:</td>
                        <td width="40%" class="borde-derecho borde-inferior texto-rojo negrita" style="font-size: 12pt;"><?= $cliente['codigo'] ?></td>
                        <td width="10%" class="borde-derecho borde-inferior">Teléfono:</td>
                        <td colspan="2" width="40%" class="borde-inferior"><?= $cliente['telefono'] ?></td>
                    </tr>
                    
                    <!-- Fila 4: Nombre y RUC -->
                    <tr>
                        <td class="borde-derecho borde-inferior" style="height: 22px;">Nombre:</td>
                    ...
                    <tr>
                        <td class="borde-derecho borde-inferior" style="height: 22px;">Envio</td>
                    ...
                    <tr class="gris-claro negrita centrado" style="font-size: 8pt;">
                        <td colspan="2" class="borde-derecho borde-inferior" style="padding: 4px; height: 18px;">GUIA</td>
                        <td width="10%" class="borde-derecho borde-inferior">PESO/VOLUMEN</td>
                        <td width="10%" class="borde-derecho borde-inferior">PRECIO</td>
                        <td width="15%" class="borde-inferior">MONTO</td>
                    </tr>
                    <tr>
                         <td colspan="2" class="borde-derecho" style="vertical-align: top; height: 1.5in; padding: 0;">
                            <table width="100%" style="border-collapse: collapse;">
                                <tr>
                                     <td class="centrado" height="1.2in" style="vertical-align: top; padding: 5px; border:none; font-family: Calibri;">
                                ...
                                <tr>
                                    <td style="vertical-align: bottom; padding: 5px 5px 12px 5px; font-family: Calibri; font-size: 8pt; border:none;">
                        ...
                        <td class="borde-derecho centrado" style="vertical-align: top; height: 1.5in; font-family: Calibri;">
                            <?php foreach($detalles as $it): ?>
                                <?= $it['cantidad'] ?><br>
                            <?php endforeach; ?>
                        </td>
                        ...
                        <td class="centrado" style="vertical-align: top; height: 1.5in; font-family: Calibri;">
                            <?php foreach($detalles as $it): ?>
                ...
                <td width="30%" style="vertical-align: top; height: 2.8in;">
                    <table width="100%" height="100%" cellpadding="3" cellspacing="0">
                        <!-- Título RECIBO # -->
                        <tr>
                            <td class="borde-inferior gris-claro centrado" style="padding: 5px 0; height: 35px;">
                                COMPROBANTE #<br>
                        ...
                        <!-- Opciones de pago -->
                        <tr>
                            <td class="borde-inferior" style="padding: 10px 0 0 10px; vertical-align: top; ">
                                <?php 
                                ...
                                <div style="margin-bottom: 8px;">
                                    <span class="check-box" style="width:14px; height:14px; line-height: 16px;"><?= $checked ? 'X' : '&nbsp;' ?></span>
            ...
            <!-- FILA INFERIOR (TOTAL Y FIRMA) -->
            <tr>
                <!-- Fecha y Total -->
                <td class="borde-derecho borde-superior" style="vertical-align: middle;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="55%" style="padding-left: 5px; font-size: 8pt;">
                                <?= date('d/m/Y h:i A') ?>
                            </td>
                            <td width="20%" class="derecha" style="padding-right: 10px;">TOTAL</td>
                            <td width="25%" class="borde-izquierdo centrado" style="font-size: 12pt;"><?= number_format($factura['total'], 2) ?></td>
                        </tr>
                    </table>
                </td>
                <!-- Firma -->
